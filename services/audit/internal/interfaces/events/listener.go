...
func (l *Listener) Start(ctx context.Context) {
	prahariLogger.Info(ctx, "Registering Audit Kafka listener: compliance.reviewed, risk.activated, incident.closed, inspection.completed, maintenance.completed, workflow.completed")
}
