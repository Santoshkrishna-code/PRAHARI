...
type AppConfig struct {
	Port                int    `env:"PORT" envDefault:"8094"`
	...
	ObservationGrpcAddr string `env:"OBSERVATION_GRPC_ADDR" envDefault:"localhost:8093"`
	...
	S3Bucket            string `env:"S3_BUCKET" envDefault:"prahari-risk-evidence"`
