...
import (
	...
	incidentMid "prahari/services/incident/internal/interfaces/http"
)

// InitRouter registers the standard middleware pipeline with department isolation.
func InitRouter(handler http.Handler) http.Handler {
	...
	pipeline := prahariMid.New(
		...
		incidentMid.DepartmentIsolationMiddleware,
	)
