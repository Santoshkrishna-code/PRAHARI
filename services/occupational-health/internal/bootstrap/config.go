...
// AppConfig maps environment config keys.
type AppConfig struct {
	Port               int    `env:"PORT" envDefault:"8098"`
	...
	TrainingGrpcAddr   string `env:"TRAINING_GRPC_ADDR" envDefault:"localhost:8097"`
	S3Bucket           string `env:"S3_BUCKET" envDefault:"prahari-health-evidence"`
	S3Region           string `env:"S3_REGION" envDefault:"ap-south-1"`
}

// LoadConfig parses environment variables into structured configuration.
