...
func key(id string) string {
	return fmt.Sprintf("nearmiss:detail:%s", id)
}

// Get returns cached record.
func (c *Cache) Get(ctx context.Context, id string) (*nearmissDomain.NearMiss, error) {
	data, err := c.client.Get(ctx, key(id))
	if err != nil {
		return nil, nil // Cache miss
	}

	var m nearmissDomain.NearMiss
...
// Set cache details.
func (c *Cache) Set(ctx context.Context, m *nearmissDomain.NearMiss) error {
