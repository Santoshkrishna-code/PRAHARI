...
func (l *Listener) Start(ctx context.Context) {
	prahariLogger.Info(ctx, "Registering Near Miss Kafka listener: inspection.completed, hazard.created, maintenance.completed, workflow.completed, incident.created")
}
