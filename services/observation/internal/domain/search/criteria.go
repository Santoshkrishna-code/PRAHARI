...
type Criteria struct {
	ObservationNumber string    `json:"observation_number,omitempty"`
	ObservationType   string    `json:"observation_type,omitempty"`
	BehaviorCategory  string    `json:"behavior_category,omitempty"`
	ObserverID        string    `json:"observer_id,omitempty"`
	ObservedPersonID  string    `json:"observed_person_id,omitempty"`
