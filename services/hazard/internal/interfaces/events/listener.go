...
func (l *Listener) Start(ctx context.Context) {
	prahariLogger.Info(ctx, "Registering Hazard Service Kafka listener subscriptions: inspection.completed, incident.created, maintenance.completed, permit.closed, workflow.completed")
}
