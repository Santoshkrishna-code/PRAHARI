...
const AppContent: React.FC = () => {
  ...
  const tabs = [
    { id: 'dashboard', label: 'Field Home' },
    { id: 'permits', label: 'My Permits' },
    { id: 'inspections', label: 'Inspections' },
    { id: 'incidents', label: 'Incident Form' },
    { id: 'ai', label: 'Safety Copilot' }
  ];
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background text-text">
      ...
      <header className="h-14 border-b border-border bg-surface flex items-center justify-between px-4 flex-shrink-0">
        <span className="text-sm font-black tracking-wider uppercase">PRAHARI Mobile Android</span>
      </header>
