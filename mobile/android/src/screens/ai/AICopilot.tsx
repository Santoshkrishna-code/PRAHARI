...
export const AICopilot: React.FC = () => {
  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      setMessages((prev) => [
        ...prev,
        { role: 'COPILOT', content: 'LOTO standard procedure 02 requires double isolation checks for hot welding permits.' }
      ]);
      setLoading(false);
    }, 400);
  };
  ...
  return (
    <div className="flex flex-col h-[60vh] border border-border rounded-lg bg-surface overflow-hidden w-full max-w-lg mx-auto">
